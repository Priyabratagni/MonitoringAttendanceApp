...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ClassName and Subject Name Viewer  Home Screen ---------------------------------
    ...
    //For Dialog ( Add Icon for Subject name) ------------ DIALOG------------------------------------------------------------------------------------------------------------------
    ...
    //Add Button clicked to add to recycler View
    ...
    private void setToolbar() {
        ...
        TextView subtitile = toolbar.findViewById(R.id.subtitle_toolbar);
        ImageButton back = toolbar.findViewById(R.id.back);
        ImageButton save = toolbar.findViewById(R.id.save);

        title.setText("Monitoring Attendance System");
        subtitile.setVisibility(View.GONE);
    ...
    // When Long Pressed class Item to show delete and EDit -- CLASS ADAPTER ============================================
    @Override
